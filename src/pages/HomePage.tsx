      ...
      <div className="flex flex-col lg:flex-row grow justify-between lg:p-24 items-center relative">
        ...
        >
          ...
          <div className="mt-4 flex lg:justify-start justify-center">
            <button className="rounded-md px-3.5 py-2 m-1 overflow-hidden relative group cursor-pointer border-b-2 font-medium border-primary text-primary text-white">
